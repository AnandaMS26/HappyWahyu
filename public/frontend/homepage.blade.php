      ...
      <div class="container-hero-lp">
        <div class="flexbox-hero-lp">
          ...
          <div class="right-block-hero-lp">
            <img class="image-hero-lp" src="img/Image.png" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section-why">
      <div class="container-why">
        ...
        <div class="section-why-images-description">
          <div class="col">
            <img src="img/Daging-ilustration.png" alt="daging-ilustrasi" />
            <p>Berasal dari daging pilihan</p>
          </div>
          <div class="col">
            <img
              src="img/Perusahaan-Ilustration.png"
              alt="perusahaan-ilustrasi"
            />
            <p>Diambil dari suppllier terpercaya</p>
          </div>
          <div class="col">
            <img src="img/Harga-Ilustration.png" alt="harga-ilustrasi" />
